...
public class Module_3_loops {
	...
	public static void main(String[] args) {
		...
		System.out.println("Will now insert n values starting at 11000 to both loops A and B, and then decreasing in value\n"
		...
		for (int var = 11000; var >= 0; var--) {
			...
			if (TimeA > TimeB) {
				System.out.println("Loop B is faster than loop A when n equals " + var + " \n");
				...
				System.out.println("Loop B is not faster than loop A for when n is between 11000 and 0");
			}
